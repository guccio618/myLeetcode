...
public class Lecture4_Two_Pointers_06_Nuts_Bolts_Problem {
    ...
    private void qsort(String[] nuts, String[] bolts, NBCompare compare, int start, int end) {
        if (start >= end) return;
    ...
    private int partition(String[] str, String pivot, NBCompare compare, int left, int right) {
        int m = left;
