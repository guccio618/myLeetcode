...
public class Le_017_Letter_Combinations_of_a_Phone_Number {
    ...
    public static void main(String[] args){
    	Le_017_Letter_Combinations_of_a_Phone_Number t = new Le_017_Letter_Combinations_of_a_Phone_Number();
