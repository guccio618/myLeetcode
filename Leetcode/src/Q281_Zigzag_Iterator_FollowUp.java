 ...
 * 
 * */
public class Q281_Zigzag_Iterator_FollowUp {
	private Queue<Iterator> queue;
	
	public Q281_Zigzag_Iterator_FollowUp(List<Integer>[] listArray) {
    ...
    public static void main(String[] args) {
    	...
    	Q281_Zigzag_Iterator_FollowUp t = new Q281_Zigzag_Iterator_FollowUp(listArray);
